...
def random_stylemix_video(
    ...
    """Generate random style-mixing video using pretrained network pickle.
        ...
        \b
        python style_mixing.py video --row_Seed=85 -cols=55,821,1789 --fps=60 --network=https://nvlabs-fi-cdn.nvidia.com/stylegan2-ada-pytorch/pretrained/metfaces.pkl

        \b
        python style_mixing.py video --row=0 --cols=7-10 --styles=fine,1,3,5-7 --duration-sec=60 --network=https://nvlabs-fi-cdn.nvidia.com/stylegan2-ada-pytorch/pretrained/metfaces.pkl
    """
    # TODO: add class_idx
